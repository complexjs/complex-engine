...
export default class World {
  ...
  public addSystem(system: EntitySystem | VoidSystem): void {
    ...
    if (system instanceof EntitySystem === true) {
      ...
      Core.getInstance().log(`World`, `Added EntitySystem`, system);
      ...
      Core.getInstance().log(`World`, `Added VoidSystem`, system);
    }
  }
   ...
   */
  public init(): void {
    Core.getInstance().log(`World`, `Initializing`);
  ...
  public addManager(manager: Manager): void {
    ...
    Core.getInstance().log(`World`, `Manager added`, manager);
